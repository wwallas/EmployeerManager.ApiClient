...
namespace EmployeeManager.ApiClient.Controllers
{
    public class EmployeeManagerController : Controller
    {
        ...
        public async Task<bool> FillCountriesAsync()
        {
            ...
            List<Country> listCountries = JsonSerializer.Deserialize<List<Country>>
            (stringData, options);
        ...
        public async Task<IActionResult> ListAsync()
        {
            ...
            List<Employee> data = JsonSerializer.Deserialize
                <List<Employee>>(stringData, options);
            return View(data);
        }
        ...
        public async Task<IActionResult> InsertAsync(Employee model)
        {
            ...
            if (ModelState.IsValid) 
            {
                ...
                var contentData = new StringContent(stringData, System.Text.
        ...
        {
            HttpResponseMessage response = await client.
                DeleteAsync($"{employeesApiUrl}/{employeeID}");
            if (response.IsSuccessStatusCode)
            {
